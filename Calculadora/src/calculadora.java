...
public class calculadora {
	...
	private static void divide(int operador1, int operador2) {
		try{
			float operador3,operador4;
			operador3=(float)operador1;
			operador4=(float)operador2;
			resultado2=(operador3/operador4);
			System.out.println("La division de "+operador3+" / "+operador4+" es "+resultado2);
		} catch (Exception e){
			System.out.println("La operacion no se puede realizar, error!!!");
		}
